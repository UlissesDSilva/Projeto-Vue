...
module.exports = app => {
  ...
  const remove = async (req, res) => {
    try {
      ...
      const rowsDel = await app.db('articles').where({id: req.params.id}).del()

      try {
        existsOrError(rowsDel, 'Artigo não encontrado')        
      } catch (msg) {
  ...
  return { save, remove, getAll, getById, getByCategory }
}